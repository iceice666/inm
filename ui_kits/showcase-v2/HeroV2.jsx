// inm showcase v2 — Hero: editorial headline + deliberate palette object
function HeroV2() {
  const cells = [
      ...
      <div className="hero-inner">
        <div className="hero-copy">
          ...
          <div className="hero-cta">
            <a className="button primary" href="#tokens">Explore the tokens</a>
            <a className="button secondary" href="#anchors">Meet the anchors</a>
          </div>
